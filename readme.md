The latest RadonEye RD200 is not supported out of the Haas box, so I came up with this workaround to read the values. Random Yaml files for Home Assistant
